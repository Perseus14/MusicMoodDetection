...
#A dictionary of mood and track_details, (a tuple containing name of track, spotify_id, list of artists, preview_url, image_url and popularity) which is already sorted by popularity
...
def recommender(mood,n=5):
	...
	while(count<n and ind<track_len):
		_,_,_,url,_,_ = track_details[ind]
		if(url):
